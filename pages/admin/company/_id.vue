        ...
        <div class="row">
            ...
            <div class="col-8">
                <v-card class="mx-auto my-12 p-38" color="blue-grey lighten-4" max-width="600"
                    v-for="companyDetails in companyDetails" key="companyDetails.id">
                    <template slot="progress">
                        <v-progress-linear color="deep-purple" height="10" indeterminate></v-progress-linear>
                    </template>
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-between" v-if="companyDetails.request_status == 1">
                            <h5>Status</h5>
                            <h5>Pending</h5>
                        </div>
...
export default {
    ...
    mounted() {
        ...
        if (auth) {
            ...
            this.$axios.get(`admin/company/${this.$route.params.id}`, config).then((Response) => {
